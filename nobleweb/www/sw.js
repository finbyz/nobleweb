...
var urlsToCache = [
    '/',
    'https://cdn.jsdelivr.net/combine/gh/finbyz/nobleweb/nobleweb/public/js/manifest.json',
    ...
    {%- endfor %}
    // JS
    'https://cdn.jsdelivr.net/combine/gh/finbyz/nobleweb/nobleweb/public/js/frappe-web.min.js,npm/bootstrap@4.1.0/dist/js/bootstrap.min.js',
